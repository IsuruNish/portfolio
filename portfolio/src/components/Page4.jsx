          ...
          <div className="row md-12">
            <div className="card cardPopUP">
              ...
              <div className="card-body">
                ...
                <p className="card-text popupContent">It was a honor to be selected as a member of the Executive Board at the Science Union of Ananda College. Scientia and Intellect was two of the events that we have organized during our term to showcase the talents of our Sri Lankan young students.</p>
              </div>
            </div>
          </div>
        </VerticalTimelineElement>
          ...
          <div className="row md-12">
            <div className="card cardPopUP">
              ...
              <div className="card-body">
                ...
                <p className="card-text popupContent">It was a great privilege to be selected as a member of the Executive Board at AIESEC in University of Colombo. This is the place where I met a lot of people around the country and also around the world. During this role I handled one of the 4 main functions in the AIESEC, Where I implemented new strategies, initiated marketing and physical campaigns to attract customers, and organized training sessions for the membership and the leadership body.</p>
              </div>
            </div>
          </div>
        </VerticalTimelineElement>

        <VerticalTimelineElement contentStyle={{ background: "#FF2E63", color: "#FF2E63" }} contentArrowStyle={{ borderRight: "7px solid  #FF2E63" }} date={"Achievements"} dateClassName={"dateStyle"} position="left" iconStyle={{ background: "#FF2E63", color: "#fff" }} icon={<Avatar src={achi} sx={{ padding: 1, width: "80%", height: "80%", margin: "auto", marginTop: 1 }} />}>
          <div className="row md-12">
            <div className="card cardPopUP">
              {/* <img src={schoolAward} className="card-img-top"/> */}
              <div className="card-body">
                <h5 className="card-title popupHeader">Emerging oGTer in Excellentia'21</h5>
                <p className="card-text popupContent">This award is given at the Annual awarding ceremony in AIESEC in University of Colombo to the member who has the highest performance in the function.</p>
          ...
          <div className="row md-12">
            <div className="card cardPopUP mt-3">
              ...
              <div className="card-body">
                ...
                <p className="card-text popupContent">This award is given at the Annual awarding ceremony in AIESEC in University of Colombo to the member in the Leadership Body who has the highest performance in the function.</p>
