    ...
    <div className="container PageFive" id="skills">
      ...
      <div className="w-100">
        <div className="progressSkill" data-aos="fade-up" data-aos-duration="2000">
          ...
          <div className="progress progressBarSkill" style={{ height: "10px" }}>
            <div className="progress-bar progress-bar-striped progress-bar-animated w-100 bg-warning" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
        ...
        <div className="progressSkill mt-4" data-aos="fade-up" data-aos-duration="2000">
          ...
          <div className="progress progressBarSkill" style={{ height: "10px" }}>
            <div className="progress-bar progress-bar-striped progress-bar-animated bg-warning" style={{ width: 700 }} role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
        ...
        <div className="progressSkill mt-4" data-aos="fade-up" data-aos-duration="2000">
          ...
          <div className="progress progressBarSkill" style={{ height: "10px" }}>
            <div className="progress-bar progress-bar-striped progress-bar-animated bg-warning" style={{ width: 730 }} role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
      ...
      <div className="w-100" id="lastSkill">
        ...
        <div className="progressSkill mt-4" data-aos="fade-up" data-aos-duration="2000">
          ...
          <div className="progress progressBarSkill" style={{ height: "10px" }}>
            <div style={{ width: 125 }} className="progress-bar progress-bar-striped progress-bar-animated bg-danger" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
