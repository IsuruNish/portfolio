  ...
  return (
    <nav className={navigation ? "container navbar navbar-expand-lg navBarPage ativate py-3" : "container navbar navbar-expand-lg navBarPage py-3"} style={{ position: "fixed", top: 0 }}>
      <div className="container">
        <h2 id="logo">
          Portfo<span className={navigation ? "spanHeading ativate" : "spanHeading"}>lio </span>
        </h2>{" "}
        <img src={logo} style={{ width: 40, marginLeft: 15 }} />
          ...
          <div className="navbar-nav ms-auto text-center">
            <ul className="navbar-nav">
              <li className="nav-item">
                <HashLink to="#home" className="nav-link active mx-2" aria-current="page">
                  <span className="linkTag" id="linkNav">
                    Home
                  </span>
                </HashLink>
              </li>
              ...
              <li className="nav-item">
                <HashLink to="#about" className="nav-link active mx-2" aria-current="page">
                  <span className="linkTag" id="linkNav2">
                    About
                  </span>
                </HashLink>
              </li>
              ...
              <li className="nav-item">
                <HashLink to="#education" className="nav-link active mx-2" aria-current="page">
                  <span className="linkTag" id="linkNav3">
                    Education
                  </span>
                </HashLink>
              </li>
              ...
              <li className="nav-item">
                <HashLink to="#ExtraCurricularActivities" className="nav-link active mx-2" aria-current="page">
                  <span className="linkTag" id="linkNav4">
              ...
              <li className="nav-item">
                <HashLink to="#skills" className="nav-link active mx-2" aria-current="page">
                  <span className="linkTag" id="linkNav5">
                    Skills
                  </span>
                </HashLink>
              </li>
              ...
              <li className="nav-item">
                <HashLink to="#projects" className="nav-link active mx-2" aria-current="page">
                  <span className="linkTag" id="linkNav6">
                    Projects
                  </span>
                </HashLink>
              </li>
              ...
              <li className="nav-item">
                <HashLink to="#contact" className="nav-link active mx-2" aria-current="page">
                  <span className="linkTag" id="linkNav7">
                    Contact Details
                  </span>
                </HashLink>
              </li>
