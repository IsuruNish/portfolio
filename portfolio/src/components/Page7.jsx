...
export default function Page7() {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_3tq30wq', 'template_w53ps5c', e.target, 'xNsEJCIaMTsGlmGPi')
          .then((result) => {
  ...
  return (
    <div className='container PageSeven' id='page7'>
        <div className='mb-3' data-aos="fade-up" data-aos-duration="800">
            <h1 id='aboutMe2' style={{color:'#EAEAEA'}}>Contact</h1>
        ...
        <div className='row contactNumbers2'>
            ...
            <div className='col-sm-6'>
                <div className='col mb-5 contactNumbers'>
                    ...
                    <h5 data-aos="fade-up" data-aos-duration="2000"><img alt="Remy Sharp" src={mail} className="mx-2" style={{width:25}}/> isurunwg@gmail.com</h5>
                    <h5 data-aos="fade-up" data-aos-duration="2000"><img alt="Remy Sharp" src={phone} className="mx-2" style={{width:25}}/> +94 766 699 117</h5>
                    <h5 data-aos="fade-up" data-aos-duration="2000"><img alt="Remy Sharp" src={location} className="mx-2" style={{width:25}}/> Colombo, Sri Lanka</h5>
                    
                </div>

                <div className='col contactNumbers'>
                    <Stack direction="row" spacing={2} sx={{display:"flex", justifyContent:"start"}}>
                        <a href='https://www.linkedin.com/in/isurunishadha/'><Avatar alt="Remy Sharp" src={li} className="mx-2" data-aos="fade-up" data-aos-duration="2000"/></a>
                        <a href='https://www.facebook.com/IsuruNishadha'><Avatar alt="Remy Sharp" src={fb} className="mx-2" data-aos="fade-up" data-aos-duration="2000"/></a>
                        <a href='https://www.instagram.com/_cheexe_/'><Avatar alt="Remy Sharp" src={insta} className="mx-2" data-aos="fade-up" data-aos-duration="2000"/></a>
                        <a href='https://github.com/IsuruNish'><Avatar alt="Remy Sharp" src={github} className="mx-2" data-aos="fade-up" data-aos-duration="2000"/></a>
                    </Stack>
                </div>
            </div>
